        ...
        <div className="layout">
          <div className="sidebar">
            <div>
              <div className="logo">
                <h2>CareSync</h2>
                <span>Patient & doctor workspace</span>
              </div>
              <div className="menu">
                <div
            ...
            <div className="body">
              ...
              {activeMenuItem !== 'applyDoctor' &&
                ...
                activeMenuItem !== 'userappointments' && (
                  <Container>
                    <h2 className="text-center p-2">Browse available doctors</h2>
                    <p className="text-center text-muted" style={{ fontSize: '0.9rem' }}>
                      Choose a doctor, upload any supporting documents, and request a time slot for
                      your visit.
                    </p>
